...
ie-7500-group-g-course-project/ ├── README.md ├── .gitignore ├── notebooks/ │ ├── NLP_Project.ipynb ├── data/ │ ├── True.csv.zip │ └── Fake.csv.zip ├── models/ │ ├── best_logreg_model.pkl │ └── fine_tuned_bert/ │ ├── config.json │ ├── pytorch_model.bin │ └── tokenizer_config.json 
